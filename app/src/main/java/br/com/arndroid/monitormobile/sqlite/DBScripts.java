package br.com.arndroid.monitormobile.sqlite;
...
import br.com.arndroid.monitormobile.provider.xs.XsEntity;
import br.com.arndroid.monitormobile.provider.comments.CommentsEntity;
import br.com.arndroid.monitormobile.provider.followers.FollowersEntity;
...
public class DBScripts {
    ...
    public static void populateDB(SQLiteDatabase db) {
        ...
        issues.add(new IssuesEntity(null, systems.get(0).getAcronymId(), TimeStampUtils.dateToTimeStamp(new Date()), IssueUtils.STATE_OPEN,   IssueUtils.FLAG_BLACK,   IssueUtils.CLOCK_BLACK,   "Incidente 1 do sistema XYZ",       "Descrição detalhada do incidente 1 do sistema XYZ.",        users.get(0).getId(), users.get(7).getId()));
        issues.add(new IssuesEntity(null, systems.get(0).getAcronymId(), TimeStampUtils.dateToTimeStamp(new Date()), IssueUtils.STATE_OPEN,   IssueUtils.FLAG_BLACK,   IssueUtils.CLOCK_RED, "Incidente 2 do sistema XYZ",       "Descrição detalhada do incidente 2 do sistema XYZ.",        users.get(1).getId(), users.get(6).getId()));
        issues.add(new IssuesEntity(null, systems.get(0).getAcronymId(), TimeStampUtils.dateToTimeStamp(new Date()), IssueUtils.STATE_OPEN,   IssueUtils.FLAG_BLACK,   IssueUtils.CLOCK_YELLOW,    "Incidente 3 do sistema XYZ",       "Descrição detalhada do incidente 3 do sistema XYZ.",        users.get(2).getId(), users.get(5).getId()));
        issues.add(new IssuesEntity(null, systems.get(0).getAcronymId(), TimeStampUtils.dateToTimeStamp(new Date()), IssueUtils.STATE_OPEN,   IssueUtils.FLAG_BLACK,   IssueUtils.CLOCK_BLUE,  "Incidente 4 do sistema XYZ",       "Descrição detalhada do incidente 4 do sistema XYZ.",        users.get(3).getId(), users.get(4).getId()));
        issues.add(new IssuesEntity(null, systems.get(0).getAcronymId(), TimeStampUtils.dateToTimeStamp(new Date()), IssueUtils.STATE_OPEN,   IssueUtils.FLAG_RED, IssueUtils.CLOCK_BLACK,   "Incidente 5 do sistema XYZ",       "Descrição detalhada do incidente 5 do sistema XYZ.",        users.get(4).getId(), users.get(3).getId()));
        issues.add(new IssuesEntity(null, systems.get(0).getAcronymId(), TimeStampUtils.dateToTimeStamp(new Date()), IssueUtils.STATE_OPEN,   IssueUtils.FLAG_RED, IssueUtils.CLOCK_RED, "Incidente 6 do sistema XYZ",       "Descrição detalhada do incidente 6 do sistema XYZ.",        users.get(5).getId(), users.get(2).getId()));
        issues.add(new IssuesEntity(null, systems.get(0).getAcronymId(), TimeStampUtils.dateToTimeStamp(new Date()), IssueUtils.STATE_OPEN,   IssueUtils.FLAG_RED, IssueUtils.CLOCK_YELLOW,    "Incidente 7 do sistema XYZ",       "Descrição detalhada do incidente 7 do sistema XYZ.",        users.get(6).getId(), users.get(1).getId()));
        issues.add(new IssuesEntity(null, systems.get(0).getAcronymId(), TimeStampUtils.dateToTimeStamp(new Date()), IssueUtils.STATE_OPEN,   IssueUtils.FLAG_RED, IssueUtils.CLOCK_BLUE,  "Incidente 8 do sistema XYZ",       "Descrição detalhada do incidente 8 do sistema XYZ.",        users.get(7).getId(), users.get(0).getId()));
        issues.add(new IssuesEntity(null, systems.get(0).getAcronymId(), TimeStampUtils.dateToTimeStamp(new Date()), IssueUtils.STATE_OPEN,   IssueUtils.FLAG_YELLOW,    IssueUtils.CLOCK_BLACK,   "Incidente 9 do sistema XYZ",       "Descrição detalhada do incidente 9 do sistema XYZ.",        users.get(0).getId(), users.get(7).getId()));
        issues.add(new IssuesEntity(null, systems.get(0).getAcronymId(), TimeStampUtils.dateToTimeStamp(new Date()), IssueUtils.STATE_OPEN,   IssueUtils.FLAG_YELLOW,    IssueUtils.CLOCK_RED, "Incidente 10 do sistema XYZ",      "Descrição detalhada do incidente 10 do sistema XYZ.",       users.get(1).getId(), users.get(6).getId()));
        issues.add(new IssuesEntity(null, systems.get(0).getAcronymId(), TimeStampUtils.dateToTimeStamp(new Date()), IssueUtils.STATE_OPEN,   IssueUtils.FLAG_YELLOW,    IssueUtils.CLOCK_YELLOW,    "Incidente 11 do sistema XYZ",      "Descrição detalhada do incidente 11 do sistema XYZ.",       users.get(2).getId(), users.get(5).getId()));
        issues.add(new IssuesEntity(null, systems.get(0).getAcronymId(), TimeStampUtils.dateToTimeStamp(new Date()), IssueUtils.STATE_OPEN,   IssueUtils.FLAG_YELLOW,    IssueUtils.CLOCK_BLUE,  "Incidente 12 do sistema XYZ",      "Descrição detalhada do incidente 12 do sistema XYZ.",       users.get(3).getId(), users.get(4).getId()));
        issues.add(new IssuesEntity(null, systems.get(0).getAcronymId(), TimeStampUtils.dateToTimeStamp(new Date()), IssueUtils.STATE_OPEN,   IssueUtils.FLAG_BLUE,  IssueUtils.CLOCK_BLACK,   "Incidente 13 do sistema XYZ",      "Descrição detalhada do incidente 13 do sistema XYZ.",       users.get(4).getId(), users.get(3).getId()));
        issues.add(new IssuesEntity(null, systems.get(0).getAcronymId(), TimeStampUtils.dateToTimeStamp(new Date()), IssueUtils.STATE_OPEN,   IssueUtils.FLAG_BLUE,  IssueUtils.CLOCK_RED, "Incidente 14 do sistema XYZ",      "Descrição detalhada do incidente 14 do sistema XYZ.",       users.get(5).getId(), users.get(2).getId()));
        issues.add(new IssuesEntity(null, systems.get(0).getAcronymId(), TimeStampUtils.dateToTimeStamp(new Date()), IssueUtils.STATE_OPEN,   IssueUtils.FLAG_BLUE,  IssueUtils.CLOCK_YELLOW,    "Incidente 15 do sistema XYZ",      "Descrição detalhada do incidente 15 do sistema XYZ.",       users.get(6).getId(), users.get(1).getId()));
        issues.add(new IssuesEntity(null, systems.get(0).getAcronymId(), TimeStampUtils.dateToTimeStamp(new Date()), IssueUtils.STATE_OPEN,   IssueUtils.FLAG_BLUE,  IssueUtils.CLOCK_BLUE,  "Incidente 16 do sistema XYZ",      "Descrição detalhada do incidente 16 do sistema XYZ.",       users.get(7).getId(), users.get(0).getId()));
        issues.add(new IssuesEntity(null, systems.get(0).getAcronymId(), TimeStampUtils.dateToTimeStamp(new Date()), IssueUtils.STATE_CLOSED, IssueUtils.FLAG_BLACK,   IssueUtils.CLOCK_BLUE,  "Incidente 17 do sistema XYZ",      "Descrição detalhada do incidente 17 do sistema XYZ.",       users.get(0).getId(), users.get(7).getId()));
        issues.add(new IssuesEntity(null, systems.get(0).getAcronymId(), TimeStampUtils.dateToTimeStamp(new Date()), IssueUtils.STATE_CLOSED, IssueUtils.FLAG_RED, IssueUtils.CLOCK_YELLOW,    "Incidente 18 do sistema XYZ",      "Descrição detalhada do incidente 18 do sistema XYZ.",       users.get(1).getId(), users.get(6).getId()));
        issues.add(new IssuesEntity(null, systems.get(0).getAcronymId(), TimeStampUtils.dateToTimeStamp(new Date()), IssueUtils.STATE_CLOSED, IssueUtils.FLAG_YELLOW,    IssueUtils.CLOCK_RED, "Incidente 19 do sistema XYZ",      "Descrição detalhada do incidente 19 do sistema XYZ.",       users.get(2).getId(), users.get(5).getId()));
        issues.add(new IssuesEntity(null, systems.get(0).getAcronymId(), TimeStampUtils.dateToTimeStamp(new Date()), IssueUtils.STATE_CLOSED, IssueUtils.FLAG_BLUE,  IssueUtils.CLOCK_BLACK,   "Incidente 20 do sistema XYZ",      "Descrição detalhada do incidente 20 do sistema XYZ.",       users.get(3).getId(), users.get(4).getId()));
        issues.add(new IssuesEntity(null, systems.get(1).getAcronymId(), TimeStampUtils.dateToTimeStamp(new Date()), IssueUtils.STATE_CLOSED, IssueUtils.FLAG_BLACK,   IssueUtils.CLOCK_BLUE,  "Um incidente do sistema SICLI",    "Descrição detalhada de um incidente  do sistema SICLI.",    users.get(4).getId(), users.get(5).getId()));
        issues.add(new IssuesEntity(null, systems.get(1).getAcronymId(), TimeStampUtils.dateToTimeStamp(new Date()), IssueUtils.STATE_OPEN,   IssueUtils.FLAG_RED, IssueUtils.CLOCK_YELLOW,    "Outro incidente do sistema SICLI", "Descrição detalhada do outro incidente  do sistema SICLI.", users.get(5).getId(), users.get(6).getId()));
        issues.add(new IssuesEntity(null, systems.get(2).getAcronymId(), TimeStampUtils.dateToTimeStamp(new Date()), IssueUtils.STATE_CLOSED, IssueUtils.FLAG_YELLOW,    IssueUtils.CLOCK_RED, "Um incidente do sistema SICID",    "Descrição detalhada de um incidente  do sistema SICID.",    users.get(6).getId(), users.get(7).getId()));
        issues.add(new IssuesEntity(null, systems.get(2).getAcronymId(), TimeStampUtils.dateToTimeStamp(new Date()), IssueUtils.STATE_OPEN,   IssueUtils.FLAG_BLUE,  IssueUtils.CLOCK_BLACK,   "Outro incidente do sistema SICID", "Descrição detalhada do outro incidente  do sistema SICID.", users.get(7).getId(), users.get(0).getId()));
        issues.add(new IssuesEntity(null, systems.get(3).getAcronymId(), TimeStampUtils.dateToTimeStamp(new Date()), IssueUtils.STATE_CLOSED, IssueUtils.FLAG_BLACK,   IssueUtils.CLOCK_YELLOW,    "Um incidente do sistema SIBEC",    "Descrição detalhada de um incidente  do sistema SIBEC.",    users.get(0).getId(), users.get(1).getId()));
        issues.add(new IssuesEntity(null, systems.get(3).getAcronymId(), TimeStampUtils.dateToTimeStamp(new Date()), IssueUtils.STATE_OPEN,   IssueUtils.FLAG_RED, IssueUtils.CLOCK_BLUE,  "Outro incidente do sistema SIBEC", "Descrição detalhada do outro incidente  do sistema SIBEC.", users.get(1).getId(), users.get(2).getId()));
        issues.add(new IssuesEntity(null, systems.get(4).getAcronymId(), TimeStampUtils.dateToTimeStamp(new Date()), IssueUtils.STATE_CLOSED, IssueUtils.FLAG_YELLOW,    IssueUtils.CLOCK_BLACK,   "Um incidente do sistema SICPF",    "Descrição detalhada de um incidente  do sistema SICPF.",    users.get(2).getId(), users.get(3).getId()));
        issues.add(new IssuesEntity(null, systems.get(4).getAcronymId(), TimeStampUtils.dateToTimeStamp(new Date()), IssueUtils.STATE_OPEN,   IssueUtils.FLAG_BLUE,  IssueUtils.CLOCK_RED, "Outro incidente do sistema SICPF", "Descrição detalhada do outro incidente  do sistema SICPF.", users.get(3).getId(), users.get(4).getId()));
        issues.add(new IssuesEntity(null, systems.get(5).getAcronymId(), TimeStampUtils.dateToTimeStamp(new Date()), IssueUtils.STATE_CLOSED, IssueUtils.FLAG_BLACK,   IssueUtils.CLOCK_RED, "Um incidente do sistema SIISO",    "Descrição detalhada de um incidente  do sistema SIISO.",    users.get(4).getId(), users.get(5).getId()));
        issues.add(new IssuesEntity(null, systems.get(5).getAcronymId(), TimeStampUtils.dateToTimeStamp(new Date()), IssueUtils.STATE_OPEN,   IssueUtils.FLAG_RED, IssueUtils.CLOCK_BLACK,   "Outro incidente do sistema SIISO", "Descrição detalhada do outro incidente  do sistema SIISO.", users.get(5).getId(), users.get(6).getId()));
        db.beginTransaction();
        try {
